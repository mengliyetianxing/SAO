   ...
   <div class="address_content">
    ...
    <thead>
     ...
     <tbody>
      ...
      <tr>
            	<td>${l.receivename }</td><td>${l.receiveprovince }${l.receivecity }${l.receivedistrict }</td><td>${l.receiveaddress }</td><td>${l.receivezip }</td><td>${l.receivemobile }</td><td>个人</td><td><a href="#">修改</a> | <a href="javascript:con(${l.shippingid })">删除</a></td>
      </tr>
      </c:forEach>
